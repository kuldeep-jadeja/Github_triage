...
- **Global scope**: `C:/Users/kulde/OneDrive/Desktop/Github_triage/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/kulde/OneDrive/Desktop/Github_triage/.opencode/notes/`)
...
2. Glob `C:/Users/kulde/OneDrive/Desktop/Github_triage/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/kulde/OneDrive/Desktop/Github_triage/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/kulde/OneDrive/Desktop/Github_triage/.opencode/notes/` — works in any directory
