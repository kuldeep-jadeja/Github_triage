...
5. Commit:
   ```bash
   node "C:/Users/kulde/OneDrive/Desktop/Github_triage/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: create thread — ${ARGUMENTS}" --files ".planning/threads/${SLUG}.md"
   ```
